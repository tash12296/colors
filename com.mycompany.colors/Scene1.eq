...
public class S1 : SEScene
{
    ...
    public void initialize(SEResourceCache rsc)
 {
        ...
        add_entity(SESpriteEntity.for_color(Color.instance("#D2691E"), get_scene_width(), get_scene_height()));
        ...
        logcolor2=add_sprite_for_color(Color.instance("#8B008B"), get_scene_width()*0.12, get_scene_height()*0.07);
        ...
        logcolor3=add_sprite_for_color(Color.instance("#483D8B"), get_scene_width()*0.12, get_scene_height()*0.07);
        ...
        logcolor4=add_sprite_for_color(Color.instance("#FF6633"), get_scene_width()*0.12, get_scene_height()*0.07);
